...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "```Maaf Hexxa Media Tidak Valid.```"
PP_CHANGED = "```Hexxa, Foto Profil Anda Telah Berhasil Diubah.```"
PP_TOO_SMOL = "```Gambar Terlalu Kecil Hexxa, Mohon Gunakan Yang Lebih Besar.```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah.```"

BIO_SUCCESS = "```Hexxa, Bio Anda Telah Berhasil Diubah.```"

NAME_OK = "```Hexxa, Nama Anda Telah Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah.```"
USERNAME_TAKEN = "```Mohon Maaf Hexxa, Username Itu Sudah Ada Yang Menggunakannya.```"
# ===============================================================
